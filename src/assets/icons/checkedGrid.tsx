const CheckedGridIcon = () => (
  <svg viewBox="0 0 32 32">
    <g>
      <path d="m17 12v-7a3.0033 3.0033 0 0 1 3-3h7a3.0033 3.0033 0 0 1 3 3v7a3.0033 3.0033 0 0 1 -3 3h-7a3.0033 3.0033 0 0 1 -3-3zm-5-10h-7a3.0033 3.0033 0 0 0 -3 3v7a3.0033 3.0033 0 0 0 3 3h7a3.0033 3.0033 0 0 0 3-3v-7a3.0033 3.0033 0 0 0 -3-3zm0 15h-7a3.0033 3.0033 0 0 0 -3 3v7a3.0033 3.0033 0 0 0 3 3h7a3.0033 3.0033 0 0 0 3-3v-7a3.0033 3.0033 0 0 0 -3-3zm12.9141 6.5 4.7929-4.793a1 1 0 0 0 -1.414-1.414l-4.793 4.7929-4.793-4.7929a1 1 0 0 0 -1.414 1.414l4.7929 4.793-4.7929 4.793a1 1 0 0 0 1.414 1.414l4.793-4.7929 4.793 4.7929a1 1 0 0 0 1.414-1.414z" />
    </g>
  </svg>
  //   <svg x="0px" y="0px" viewBox="0 0 360.49 360.49">
  //     <g>
  //       <g>
  //         <g>
  //           <path
...
export default CheckedGridIcon;
